...
module Capybara::DSL
  ...
  def double_click(*arg, &arg1); end

  def evaluate_async_script(*arg, &arg1); end
...
class Counter
  include ::Counter::GeneratedAttributeMethods
  include ::Counter::GeneratedAssociationMethods
end

module Counter::GeneratedAssociationMethods
end

module Counter::GeneratedAssociationMethods
end

module Counter::GeneratedAttributeMethods
end
...
class Selenium::WebDriver::SeleniumManager
  def self.driver_path(driver_name); end
end
